...
add_action('admin_init', 'FBTPFW_check_plugin_state');
function FBTPFW_check_plugin_state(){
...
add_action( 'admin_notices', 'FBTPFW_show_notice');
function FBTPFW_show_notice() {
